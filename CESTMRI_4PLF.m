% CEST MRI analysis using 4-pool Lorentzian fitting (4PLF)  
...
par = lsqcurvefit(@lorentzian4pool,iv,offs,z,lb,ub); % Fitted parameters
...
figure, plot(offs, z, 'bo', offs, zFit, 'b-',...
             ...
             offs, noe, 'c-.', offs, mt, 'm-.', 'LineWidth',1.5);
% axis([-10,10,0,1.02]); 
